...
void CompileThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->finish((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (CompileThread::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CompileThread::finish)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject CompileThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_CompileThread.data,
      qt_meta_data_CompileThread,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void CompileThread::finish(bool _t1)
{
